...
mod tests {
    ...
    use crate::session::capture::{
        collect_codex_sessions, extract_codex_uuid_from_filename,
        extract_gemini_project_hash_from_file, extract_gemini_session_id_from_file,
        extract_vibe_cwd_from_meta, extract_vibe_session_id_from_meta, filter_agent_sessions,
    };
