// Structured view @-mention file index.
//
// `GET /api/sessions/:id/acp/files` walks the session's project_path
...
// back. Independent of the structured view supervisor: the handler talks straight
